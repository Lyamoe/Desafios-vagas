...
for (let i = 0; i < faturamento.length; i++) {
    if (faturamento[i].valor < menorValor && faturamento[i].valor != 0) {
        menorValor = faturamento[i].valor;
    } else if (faturamento[i].valor > maiorValor) {
...
const MEDIA = soma / (faturamento[i].length - diasSemFaturamento);
...
console.log(`O número de dias acima da média mensal foi: ${diasAcimaDaMedia}`);